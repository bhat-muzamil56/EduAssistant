...
router.post("/sessions/:sessionId/stream", authMiddleware, async (req: AuthRequest, res) => {
  ...
  try {
    ...
    const systemPrompt = `You are MuzamilAI — a powerful, universal AI assistant built by Muzamil Arshid, powered by both OpenAI GPT and Google Gemini. You answer ANY question on ANY topic.
${langBlock}
