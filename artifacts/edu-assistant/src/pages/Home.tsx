...
const CAPABILITY_DETAILS = [
  {
    ...
    badge: "🤖 AI Power",
    what: "AskEdu uses two AI models simultaneously. First, Google Gemini generates a quick intuitive explanation. Then, GPT takes that explanation plus the knowledge base results and synthesises a final, polished, structured answer. You get the best of both models in every single response.",
    frontend: [
  ...
  },
  {
    ...
    badge: "🔒 Security",
    what: "Every account and conversation in AskEdu is fully secured. Passwords are never stored as plain text — they're hashed with bcrypt. When you log in, you receive a JWT (JSON Web Token) that proves your identity. Every API call to the chat requires this token — without it, no data is accessible.",
    frontend: [
  ...
  },
  {
    ...
    badge: "⚙️ Admin",
    what: "The Admin Dashboard is a special protected page only accessible to admin accounts. It gives administrators a complete overview of the platform — all registered users, all chat sessions, message counts, and activity statistics. It's the control centre for managing and monitoring AskEdu.",
    frontend: [
  ...
  },
  {
    ...
    badge: "🎙️ Voice",
    what: "Voice Interaction lets you speak to AskEdu instead of typing. Press the mic button, speak your question, and the browser transcribes it instantly using the Web Speech API. When you use the mic, the AI also speaks the answer back to you using text-to-speech — a full hands-free experience.",
    frontend: [
...
const FEATURE_DETAILS = [
  ...
  },
  {
    ...
    badge: "🛡️ Reliability",
    what: "Factual Accuracy means AskEdu only tells you things it knows for certain. When a question matches the curated knowledge base, the AI is given that verified content as its source — reducing the chance of made-up or incorrect answers. A confidence score is always shown so you know how sure the system is.",
    frontend: [
  ...
  },
  {
    ...
    badge: "🧠 Memory",
    what: "Contextual Memory means AskEdu remembers everything you said earlier in the conversation. If you ask a follow-up question like 'Can you explain that differently?' it knows what 'that' refers to. Your entire conversation history is stored in the database and sent to the AI with every new message.",
    frontend: [
  ...
  },
  {
    ...
    color: "from-pink-500 to-rose-600",
    badge: "🎨 Design",
    what: "Modern UI/UX means AskEdu looks and feels like a professional app. The interface is clean, animated, responsive (works on phone, tablet, and desktop), and supports dark mode. It's built with the same design principles as ChatGPT — minimal, distraction-free, and easy to use.",
    frontend: [
  ...
  },
  {
    ...
    badge: "🗄️ Admin",
    what: "Extensible Base means the knowledge AskEdu uses can be expanded at any time. Admins can add new Q&A pairs to the PostgreSQL database and the AI will immediately start using them — no code changes, no redeployment needed. There's also a built-in Admin Panel to manage users and sessions.",
    frontend: [
                ...
                <>
                  <div className="bg-gradient-to-r from-violet-500 to-indigo-600 p-6 rounded-t-2xl">
                    ...
                    <div className="flex items-center gap-3 mb-2">
                      ...
                      <div>
                        <div className="text-white/70 text-xs font-bold uppercase tracking-widest">🧠 How AskEdu Thinks</div>
                  ...
                  <div className="p-6 space-y-6">
                    ...
                    <div>
                      <h3 className="font-bold text-foreground mb-3 flex items-center gap-2"><span className="w-2 h-2 rounded-full bg-primary inline-block" />How it works in AskEdu</h3>
                      <ol className="space-y-2">
                        {[
                ...
                <>
                  ...
                  <div className="p-6 space-y-6">
                    <div>
                      ...
                      <p className="text-muted-foreground text-sm leading-relaxed">Curated Data means the information AskEdu uses has been <strong>hand-picked, verified, and organised</strong> by humans — not scraped randomly from the internet. Every Q&A entry in the knowledge base was carefully written or approved to ensure it is accurate, clear, and trustworthy. This is the opposite of an AI that "makes things up."</p>
                    </div>
                    <div className="bg-amber-50 dark:bg-amber-950/30 border border-amber-200 dark:border-amber-800 rounded-xl p-4">
                      <h3 className="font-bold text-foreground mb-2 flex items-center gap-2">💡 Real-life analogy</h3>
      ...
      <section className="py-24">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            ...
            <p className="text-muted-foreground text-lg">Modern technologies powering AskEdu.</p>
          </div>
      ...
      <section className="py-24">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            ...
            <p className="text-muted-foreground">Everything that's live and working in AskEdu right now.</p>
          </div>
