    ...
    <div className="min-h-screen bg-background flex items-center justify-center px-4 py-12">
      <div className="w-full max-w-md">
        <div className="text-center mb-8">
          ...
          <p className="text-muted-foreground mt-2">Join MuzamilAI and start learning today</p>
        </div>
        ...
        <form onSubmit={handleSubmit} className="bg-card border border-border rounded-2xl p-8 shadow-lg">
          ...
          <div className="space-y-5">
            <div>
              ...
              <p className="text-xs text-muted-foreground mt-1.5">Letters, numbers and underscores only. At least 3 characters.</p>
            </div>
